    ...
    <>
        ...
        >
          ...
          <div className="flex items-center z-10 flex-1">
            <Link href="/" aria-label="Tidymimo Home" className="transition-transform hover:scale-105 active:scale-95">
              <Image src="/assets/LogoNoBgTextBlack.png" alt="Tidy Mimo Logo" width={110} height={30} className="logo-light object-contain w-[85px] md:w-[110px]" priority style={{ height: 'auto' }} />
              <Image src="/assets/LogoNoBgTextWhite.png" alt="Tidy Mimo Logo" width={110} height={30} className="logo-dark object-contain w-[85px] md:w-[110px]" priority style={{ height: 'auto' }} />
            </Link>
          </div>
      ...
      >
        <div className="flex justify-between items-center mb-12">
          <Image src="/assets/LogoNoBgTextBlack.png" alt="Tidy Mimo Logo" width={100} height={26} className="logo-light object-contain w-[85px]" style={{ height: 'auto' }} />
          <Image src="/assets/LogoNoBgTextWhite.png" alt="Tidy Mimo Logo" width={100} height={26} className="logo-dark object-contain w-[85px]" style={{ height: 'auto' }} />
